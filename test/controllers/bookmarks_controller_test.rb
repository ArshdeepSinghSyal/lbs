...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { lib_book_id: @bookmark.lib_book_id, user_id: @bookmark.user_id } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { lib_book_id: @bookmark.lib_book_id, user_id: @bookmark.user_id } }
